...
url = "https://www.glowpick.com/products/81847"
...
#
#         sql = """
#             INSERT INTO ingredient(name_kor, name_eng, explain, ewg_rank, cosmetic_no)
#             VALUES(:1, :2, :3, :4, '105')
#         """
#         cur = conn.cursor()
#
#         cur.execute(sql, [ing_kor, ing_eng, ing_desc, ewg_real])
